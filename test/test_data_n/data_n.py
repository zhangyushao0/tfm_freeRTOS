...
with open('data_n.txt', 'r') as file:
    lines = file.readlines()

# 遍历每一行，提取包含'r3'、'r4'、'r5'、'r6'的行
result = []
for line in lines:
    if 'r3' in line or 'r4' in line or 'r5' in line or 'r0' in line:
...
with open('../data/data_n.csv', 'w') as file:
    for r in res:
        file.write(r[0] + "," + r[2] + "," + r[3] + "," + r[4] + "," + r[1] + "\n")

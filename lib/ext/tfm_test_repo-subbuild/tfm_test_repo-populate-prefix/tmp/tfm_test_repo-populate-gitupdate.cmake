...
execute_process(
  COMMAND "/usr/bin/git" show-ref 7cf20ef
  WORKING_DIRECTORY "/home/han/srtp/tfm_freertos_aslr/tfm_freeRTOS/lib/ext/tfm_test_repo-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/7cf20ef")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "7cf20ef")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 7cf20ef
  WORKING_DIRECTORY "/home/han/srtp/tfm_freertos_aslr/tfm_freeRTOS/lib/ext/tfm_test_repo-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/han/srtp/tfm_freertos_aslr/tfm_freeRTOS/lib/ext/tfm_test_repo-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/han/srtp/tfm_freertos_aslr/tfm_freeRTOS/lib/ext/tfm_test_repo-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()

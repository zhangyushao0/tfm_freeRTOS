...
__attribute__((naked)) void HardFault_Handler(void) {
  ...
  __ASM volatile("bl        C_HardFault_Handler     \n"
                 "b         .                       \n");
}
...
__attribute__((naked)) void MemManage_Handler(void) {
  ...
  __ASM volatile("bl        C_MemManage_Handler     \n"
                 "b         .                       \n");
}
...
__attribute__((naked)) void BusFault_Handler(void) {
  ...
  __ASM volatile("bl        C_BusFault_Handler      \n"
                 "b         .                       \n");
}
...
__attribute__((naked)) void SecureFault_Handler(void) {
  ...
  __ASM volatile("bl        C_SecureFault_Handler   \n"
                 "b         .                       \n");
}

void C_UsageFault_Handler(void) { tfm_core_panic(); }

__attribute__((naked)) void UsageFault_Handler(void) {
  EXCEPTION_INFO(EXCEPTION_TYPE_USAGEFAULT);

  __ASM volatile("bl        C_UsageFault_Handler   \n"
                 "b         .                      \n");
}

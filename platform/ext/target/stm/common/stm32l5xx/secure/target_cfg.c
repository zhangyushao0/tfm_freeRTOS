...
#if (defined(MBEDTLS_SHA256_C) && defined(MBEDTLS_SHA256_ALT)) || (defined(MBEDTLS_SHA1_C) && defined(MBEDTLS_SHA1_ALT)) || (defined(MBEDTLS_MD5_C) && defined(MBEDTLS_MD5_ALT))
    HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_HASH, GTZC_TZSC_PERIPH_SEC | GTZC_TZSC_PERIPH_NPRIV);
#endif
#if (defined(MBEDTLS_ECP_C) && defined(MBEDTLS_ECP_ALT)) || (defined(MBEDTLS_ECDSA_C) && (defined(MBEDTLS_ECDSA_SIGN_ALT) || defined(MBEDTLS_ECDSA_SIGN_ALT)))
    HAL_GTZC_TZSC_ConfigPeriphAttributes(GTZC_PERIPH_PKA, GTZC_TZSC_PERIPH_SEC | GTZC_TZSC_PERIPH_NPRIV);
#endif
#if (defined(MBEDTLS_AES_C) && defined(MBEDTLS_AES_ALT)) || (defined(MBEDTLS_GCM_C) && defined(MBEDTLS_GCM_ALT)) || (defined(MBEDTLS_CCM_C) && defined(MBEDTLS_CCM_ALT))

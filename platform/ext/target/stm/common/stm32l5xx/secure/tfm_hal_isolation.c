...
tfm_hal_set_up_static_boundaries(uintptr_t *p_spm_boundary) {
 ...
 *      BIT |               1                |                           0 | |
 * 1: privileged, 0: unprivileged | 1: Trustzone-specific NSPE, 0: Secure
 * partition |
 *
 * - For isolation level 1/2
 *      BIT | 31     2 |              1                | 0                     |
 *          | Reserved |1: privileged, 0: unprivileged | 1: Trustzone-specific
 * NSPE, 0: Secure partition |
 *

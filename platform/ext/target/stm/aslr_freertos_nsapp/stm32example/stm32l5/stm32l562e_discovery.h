...
/** @defgroup STM32L562E-DK_COMMON_Exported_Types STM32L562E-DK COMMON Exported
 * Types
 * @{
 */
...
/** @defgroup STM32L562E-DK_COMMON_Exported_Constants STM32L562E-DK COMMON
 * Exported Constants
 * @{
 */
 ...
 */
#define STM32L562E_DISCOVERY_BSP_VERSION_MAIN                                  \
  (0x01U) /*!< [31:24] main version */
#define STM32L562E_DISCOVERY_BSP_VERSION_SUB1                                  \
  (0x01U) /*!< [23:16] sub1 version */
#define STM32L562E_DISCOVERY_BSP_VERSION_SUB2                                  \
  (0x02U) /*!< [15:8]  sub2 version */
#define STM32L562E_DISCOVERY_BSP_VERSION_RC                                    \
  (0x00U) /*!< [7:0]  release candidate */
#define STM32L562E_DISCOVERY_BSP_VERSION                                       \
  ((STM32L562E_DISCOVERY_BSP_VERSION_MAIN << 24U) |                            \
...
HAL_StatusTypeDef MX_LPUART1_Init(UART_HandleTypeDef *huart,
                                  MX_UART_InitTypeDef *MXInit);
HAL_StatusTypeDef MX_USART1_Init(UART_HandleTypeDef *huart,
                                 MX_UART_InitTypeDef *MXInit);

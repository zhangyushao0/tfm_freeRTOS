...
#define NS_MPU_START_ASLR ALSR_FLASH_UNEXECUTABLE_REGION_START
#define NS_MPU_END_ASLR ALSR_FLASH_UNEXECUTABLE_REGION_END
...
enum mpu_armv8m_error_t_aslr { MPU_ARMV8M_OK, MPU_ARMV8M_ERROR };
 ...
 * \note This function doesn't check if dev is NULL.
 */
enum mpu_armv8m_error_t_aslr mpu_armv8m_disable_aslr(
 ...
 * \note This function doesn't check if dev is NULL.
 */
enum mpu_armv8m_error_t_aslr mpu_armv8m_clean_aslr(
    struct mpu_armv8m_dev_t_aslr* dev);
...
enum mpu_armv8m_error_t_aslr mpu_armv8m_region_disable_aslr(
    struct mpu_armv8m_dev_t_aslr* dev, uint32_t region_nr);
